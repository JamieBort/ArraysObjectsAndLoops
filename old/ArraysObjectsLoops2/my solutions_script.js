...
console.log(0*numberArray[0]+1*numberArray[1]+2*numberArray[2]+3*numberArray[3]+4*numberArray[4]+5*numberArray[5]+6*numberArray[6]+7*numberArray[7]+8*numberArray[8]+9*numberArray[9]+10*numberArray[10]+11*numberArray[11]+12*numberArray[12]);
console.log(0*numberArray[0]);
console.log(1*numberArray[1]);
console.log(2*numberArray[2]);
console.log(3*numberArray[3]);
console.log(4*numberArray[4]);
console.log(5*numberArray[5]);
console.log(6*numberArray[6]);
console.log(7*numberArray[7]);
console.log(8*numberArray[8]);
console.log(9*numberArray[9]);
console.log(10*numberArray[10]);
console.log(11*numberArray[11]);
console.log(12*numberArray[12]);
