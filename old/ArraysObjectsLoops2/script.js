...
function getBigNumber() {
  ...
  // return numberArray[0] + numberArray[1] + numberArray[2] + numberArray[3] + numberArray[4] + numberArray[5] + numberArray[6] + numberArray[7] + numberArray[8] + numberArray[9] + numberArray[10] + numberArray[11] + numberArray[12];
}
...
// I am close with the following:
  ...
  // for (var i = 0, var j = 0; i < matrix.length, j = matrix.length; i++, j++) {
  //
  // }
//}
